...
var routes = [
    ...
    {
        path: 'auth',
        loadChildren: function () { return __webpack_require__.e(/*! import() | auth-auth-module */ "auth-auth-module").then(__webpack_require__.bind(null, /*! ./auth/auth.module */ "./src/app/auth/auth.module.ts")).then(function (m) { return m.AuthPageModule; }); }
    },
    {
        path: 'places',
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.initializeApp = function () {
        this.platform.ready().then(function () {
            ...
            if (_capacitor_core__WEBPACK_IMPORTED_MODULE_3__["Capacitor"].isPluginAvailable('SplashScreen')) {
                _capacitor_core__WEBPACK_IMPORTED_MODULE_3__["Plugins"].SplashScreen.hide();
            }
        });
    };
...
var environment = {
    production: false,
    googleMapsAPIKey: 'AIzaSyAvACtwAM7Tr77XypJIdWB5EZQ_dRygxJI'
};
/*
...
module.exports = __webpack_require__(/*! /Users/sg0304185/Desktop/projects/Angular/ionic-angular-course/src/main.ts */"./src/main.ts");
